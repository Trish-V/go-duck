...
// GetAll handles fetching all Authors with filtering and pagination
...
// GetByID handles fetching a single Author by ID
...
// Update handles full update of a Author
...
// Patch handles partial update of a Author
...
// BulkCreate handles creating multiple Authors
func (ctrl *AuthorController) BulkCreate(c *gin.Context) {
	tenant, _ := c.Get("tenantDB")
	tenantStr := fmt.Sprintf("%v", tenant)
	ctx := c.Request.Context()
...
// BulkUpdate handles updating multiple Authors
func (ctrl *AuthorController) BulkUpdate(c *gin.Context) {
	tenant, _ := c.Get("tenantDB")
	tenantStr := fmt.Sprintf("%v", tenant)
	ctx := c.Request.Context()
...
// BulkPatch handles partial updating multiple Authors
func (ctrl *AuthorController) BulkPatch(c *gin.Context) {
	tenant, _ := c.Get("tenantDB")
	tenantStr := fmt.Sprintf("%v", tenant)
	ctx := c.Request.Context()
...
// Delete handles deleting a Author by ID
